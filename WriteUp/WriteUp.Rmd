...
title: "Diversification analysis of the ALSI using GARCH (come back to this)"
...
```{r Figure1,  warning =  FALSE, fig.align = 'center', fig.cap = "Cumulative Returns of ALSI \\label{Figure1}", fig.ext = 'png', fig.height = 3, fig.width = 6}
